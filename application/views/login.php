			...
			<div class="card-body">
				...
				<form action="<?= site_url('auth'); ?>" method="post">
					<div class="input-group mb-3">
						<input type="text" class="form-control lowercase <?= $this->session->flashdata('username_state'); ?>" id="username" name="username" placeholder="Username" autocomplete="username" value="<?= $this->session->flashdata('username_value'); ?>" required>
