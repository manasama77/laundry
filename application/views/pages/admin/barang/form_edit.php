...
<section class="content">
	<div class="container-fluid">
		<form action="<?= site_url('barang/update'); ?>" method="post">
			<div class="row">
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Barang" value="<?= $arr->row()->nama; ?>" required>
							</div>
